                    ...
                    {mode === "register" && (
                      <div className="flex gap-4 items-end">
                        ...
                        >
                          ...
                          {uploadingProfileImage ? <Loader2 className="w-5 h-5 text-primary animate-spin" /> : profileImageUrl ? <img src={profileImageUrl} className="w-full h-full object-cover" onError={(e) => { (e.target as HTMLImageElement).src = "https://ui-avatars.com/api/?name=User&background=random"; }} /> : <User className="w-5 h-5 text-white/30" />}
                        </div>
