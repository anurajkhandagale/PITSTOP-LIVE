            ...
            <AnimatePresence mode="wait">
              ...
              {step === "otp" && (
                <motion.form key="otp" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} onSubmit={handleVerifyOtp} className="space-y-10 text-center">
                  <div className="space-y-2">
                     <h3 className="text-3xl font-black font-outfit uppercase italic text-white tracking-tighter">Security Key</h3>
                     <p className="text-[10px] text-white/30 font-black uppercase tracking-widest italic">Verification code dispatched to terminal</p>
                  </div>
                  <Input 
                     placeholder="000000" 
                  ...
                  {devOtp && (
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="p-8 rounded-[32px] bg-primary/5 border border-primary/20 relative overflow-hidden group">
                      ...
                      <p className="text-[10px] font-black text-primary uppercase tracking-[0.3em] mb-2 italic">Dev Link Override</p>
